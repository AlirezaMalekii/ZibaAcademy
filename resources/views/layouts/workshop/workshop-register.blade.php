            ...
            <div class="col-12 col-lg-8 register-right">
                ...
                <div class="register-table p-4 mt-3">
                    <div class="d-flex flex-column">
                        ...
                        <div class="row register-number-wrapper d-flex justify-content-between align-items-center flex-row-reverse p-4">
                            <h3 class="col-8 col-lg-10 text-right mt-2">
                                تعداد
                            </h3>
                            <div class="col-4 col-lg-2 d-flex register-number justify-content-between px-1 align-items-center align-content-center">
                        ...
                        <div class="register-table-update pt-3">
                            <div class="d-flex flex-column flex-lg-row-reverse justify-content-between align-items-center">
                                <form class="d-flex flex-row-reverse mt-3">
                                    <div class="form-group discount-input ml-2">
                                        <input type="text" placeholder="کد تخفیف خود را وارد کنید" name="discount" id="discount">
                                    </div>
