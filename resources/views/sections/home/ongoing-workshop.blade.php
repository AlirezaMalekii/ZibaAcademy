<section class="last-workshops mt-5">
    <div class="container">
        <div class="last-workshops-title mb-4">
            <h2 class="text-right">
                ورکشاپ های در حال برگزاری
            </h2>
        </div>
        <div class="row d-flex" style="flex-direction: row-reverse">
            <!-- last-workshop-item -->
            @foreach($going_workshops as $going_workshop)

                <div class="col-6 col-lg-4 last-card-container">
                    <a href="{{route('choose-workshop',$going_workshop->slug)}}">
