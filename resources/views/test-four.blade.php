                ...
                @foreach($tickets as $ticket)
                    <div class="user-ticket-wrapper d-flex flex-column flex-lg-row-reverse row">
                        <div class="user-ticket-card d-flex flex-column col-12 col-lg-9 p-3">
                            <div class="user-ticket-card-desc d-flex flex-column flex-lg-row-reverse align-items-center">
                                ...
                                <div class="user-ticket-card-about text-center text-lg-right pr-0 pr-lg-2 mt-3 mt-lg-0">
                                    ...
                                    <div class="user-ticket-card-about-desc">
                                        <div class="user-ticket-card-about-desc-item d-flex flex-row justify-content-center justify-content-lg-end">
                                            <p>
                                                محل برگزاری :
                                                <span>
                                                        {{$ticket->workshop->city->name}}
                                            </span>
                                            </p>
                            ...
                            <div class="ticket-card-price d-flex flex-row-reverse justify-content-between px-2 pt-2 mt-2">
                                <h4 class="text-right">
                                    قیمت بلیط:
                                    <span>
                        ...
                        <div class="user-ticket-left align-items-center d-flex flex-column col-12 col-lg-3 py-3">
                            ...
                            <div class="user-ticket-qr">
                                <img src="storage/{{$ticket->files->file['path']}}" alt="qr-code">
                            </div>
                        </div>
                    </div>
                @endforeach
