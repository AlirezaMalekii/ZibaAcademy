...
return [
    ...
    'custom'               => [
        ...
        'name.*.max' => "نام انتخابی شماره :position بیشتر از کاراکتور مجاز است",
        'name.*.string' => "در نام انتخابی شماره :position از کاراکترهای غیر قابل خوانش استفاده شده است",
        'name.*.required' => "نام انتخابی شماره :position خالی است",
        'lastname.*.max' => "نام خانوادگی انتخابی شماره :position بیشتر از کاراکتور مجاز است",
        'lastname.*.string' => "در نام خانوادگی انتخابی شماره :position از کاراکترهای غیر قابل خوانش استفاده شده است",
        'lastname.*.required' => "نام خانوادگی انتخابی شماره :position خالی است",
        'email.*.email' => "فرمت ایمیل شماره :position رعایت نشده است",
        'email.*.distinct' => "ایمیل شماره :position تگراری است",
        'phone.*.distinct' => "شماره تلفن شماره :position تگراری است",
        'phone.*.digits' => "شماره تلفن نباید کمتر یا بیش تر از 11 کاراکتر باشد",
        'phone.*.required' => "شماره تلفن فرم :position خالی است",
    ],
    'attributes' => [
        'address' => 'نشانی',
        'age' => 'سن',
